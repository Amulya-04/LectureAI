...
class LectureAgent:
    ...
    def __init__(
        ...
        # RAG pipeline (level-aware)
        self.rag = RAGPipeline(llm=self.llm, user_level=user_level)

        # Simple conversation memory as plain list
    ...
    def set_user_level(self, level: str):
        """Dynamically update this agent's user level (called after level-up)."""
        self.user_level = level
        self.rag.set_user_level(level)
